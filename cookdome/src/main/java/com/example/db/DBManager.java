...
public class DBManager {
    ...
    public void creates(String dbName, int version, String tableName [], String sql[]) {
        if (isSqlSuccessed) {
            mSQLiteOpenHelper = new MultiTableHelper(context, dbName, version, tableName, sql);
        } else {
            Log.e(TAG, "Sql语句不合法");
        }
    }
    ...
    public DBManager addForergn ( String id,String table,String id2) {
        mSqlBuffer.append("FOREIGN KEY("+id+") REFERENCES "+table+ "("+id2+")");
        return this;
    }
